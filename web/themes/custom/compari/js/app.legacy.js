...
function renderProducts() {
  console.debug('[CH] renderProducts disabled for static HTML Drupal prep');
  // TODO (Drupal): JS rendering disabled. Grids are now static HTML in index.html for Twig.
  /*
