 ...
 *
 * Endpoint: GET /events-calendar/events.json
  ...
  public function list(): JsonResponse {
    ...
    if (!empty($nids)) {
      ...
      foreach ($nodes as $node) {
        // Support both field_scheduled_date and field_date field names.
        $date_field = NULL;
    ...
    // Sort ascending by date so FullCalendar's initialDate points to the
